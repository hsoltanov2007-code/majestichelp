...
const criminalArticles = [
  ...
  { article: "15.1 ч.1", stars: 4, court: true, description: "Превышение должностных полномочий", fine: "от 30 до 40 месяцев лишения свободы, либо уголовный штраф в размере от 40.000$ до 100.000$" },
  ...
  { article: "15.1.1 ч.1", stars: 5, court: true, description: "Злоупотребление должностными полномочиями", fine: "от 40 до 50 месяцев лишения свободы, либо уголовный штраф в размере от 50.000$ до 100.000$" },
  { article: "15.1.1 ч.2", stars: 5, court: true, description: "Помеха задержанию или разбирательству", fine: "от 40 до 50 месяцев лишения свободы, либо уголовный штраф в размере от 40.000$ до 90.000$" },
  { article: "15.1.1 ч.3", stars: 5, court: true, description: "Злоупотребление полномочиями следствием", fine: "от 40 до 50 месяцев лишения свободы" },
  { article: "15.2", stars: 3, court: true, description: "Неисполнение распоряжений госслужащим", fine: "" },
  { article: "15.2 ч.1", stars: 3, court: true, description: "Неисполнение приказа госслужащим", fine: "от 20 до 40 месяцев лишения свободы, либо уголовный штраф в размере от 30.000$ до 40.000$" },
  { article: "15.2 ч.2", stars: 3, court: true, description: "Неисполнение приказов власти", fine: "от 20 до 40 месяцев лишения свободы, либо уголовный штраф в размере от 30.000$ до 40.000$" },
  { article: "15.2 ч.3", stars: 3, court: true, description: "Неисполнение правовых актов", fine: "от 20 до 40 месяцев лишения свободы, либо уголовный штраф в размере от 30.000$ до 40.000$" },
  { article: "15.2 ч.4", stars: 3, court: true, description: "Неисполнение правовых актов госслужащим", fine: "от 20 до 40 месяцев лишения свободы, либо уголовный штраф в размере от 30.000$ до 40.000$" },
  ...
  { article: "15.3 ч.2", stars: 3, court: true, description: "Присвоение полномочий должностного лица", fine: "от 20 до 40 месяцев лишения свободы, либо уголовным штрафом в размере от 30.000$ до 60.000$" },
  ...
  { article: "15.6 ч.1", stars: 3, court: true, description: "Халатность должностного лица", fine: "от 20 до 40 месяцев лишения свободы, либо уголовным штрафом в размере от 40.000$ до 70.000$" },
  ...
  { article: "15.7 ч.1", stars: 2, court: true, description: "Нарушение этики должностным лицом", fine: "от 10 до 30 месяцев лишения свободы, либо уголовный штраф в размере от 30.000$ до 70.000$" },
