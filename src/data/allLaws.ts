...
export const allLawsList: LawListItem[] = [
  { id: "procedural-code", title: "Процессуальный кодекс штата San-Andreas", shortTitle: "ПК", type: "code", forumUrl: "https://forum.majestic-rp.ru/threads/protsessualnyj-kodeks-shtata-san-andreas.2579881/" },
  { id: "traffic-code", title: "Дорожный кодекс штата San-Andreas", shortTitle: "ДК", type: "code", forumUrl: "https://forum.majestic-rp.ru/threads/dorozhnyj-kodeks-shtata-san-andreas.2579884/" },
  ...
  { id: "civil-code", title: "Гражданский кодекс штата San-Andreas", shortTitle: "ГК", type: "code", forumUrl: "https://forum.majestic-rp.ru/threads/grazhdanskij-kodeks-shtata-san-andreas.2579874/" },
  ...
  { id: "judicial-law", title: "Конституционный Закон О судебной системе штата Сан-Андреас", shortTitle: "О судебной системе", type: "law", forumUrl: "https://forum.majestic-rp.ru/threads/konstitutsionnyj-zakon-o-sudebnoj-sisteme-shtata-san-andreas.2580091/" },
  ...
  { id: "fib-law", title: "Закон О Федеральном Расследовательском Бюро", shortTitle: "О ФРБ", type: "law", forumUrl: "https://forum.majestic-rp.ru/threads/zakon-o-federalnom-rassledovatelskom-byuro.2580100/" },
  ...
  { id: "hunting-law", title: "Закон Об охоте и рыбалке на территории штата San-Andreas", shortTitle: "Об охоте", type: "law", forumUrl: "https://forum.majestic-rp.ru/threads/zakon-ob-okhote-i-rybalke-na-territorii-shtata-san-andreas.2580241/" },
  { id: "awards-law", title: "Закон О Государственных наградах штата San-Andreas", shortTitle: "О наградах", type: "law", forumUrl: "https://forum.majestic-rp.ru/threads/zakon-o-gosudarstvennykh-nagradakh-shtata-san-andreas.2580238/" },
  { id: "warrant-law", title: "Закон О системе ордеров штата San-Andreas", shortTitle: "Об ордерах", type: "law", forumUrl: "https://forum.majestic-rp.ru/threads/zakon-o-sisteme-orderov-shtata-san-andreas.2580235/" },
];
