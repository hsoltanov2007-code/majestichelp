  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 15px hsl(var(--accent) / 0.15)" },
          "50%": { boxShadow: "0 0 30px hsl(var(--accent) / 0.3)" },
        },
      },
      animation: {
      ...
      backgroundImage: {
        ...
        "hero-gradient": "linear-gradient(135deg, hsl(var(--primary) / 0.1) 0%, hsl(var(--background)) 50%, hsl(var(--accent) / 0.1) 100%)",
